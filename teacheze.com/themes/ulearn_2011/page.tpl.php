<?php
if ($_SERVER['REQUEST_URI'] == '/english_courses_ulearn') {
    header('Location: /');
    exit;
}
// if (!strstr($_SERVER['REQUEST_URI'], 'admin') && !isset($_GET['original']) && ($_SERVER['REMOTE_ADDR'] == '212.36.31.70' || isset($_GET['demo']))) {
if (!strstr($_SERVER['REQUEST_URI'], 'admin')) { // isset($_GET['demo']) &&
    include_once('page-dev.tpl.php');
} else {
?>
...
/*Footer copyright removed: <p><a href="#">Contact Us</a>&nbsp;|&nbsp;<a href="#">Terms of Use</a>&nbsp;|&nbsp;<a href="#">Trademarks</a>&nbsp;|&nbsp;<a href="#">Privacy Statement</a><br />'.
                     'Copyright &copy; 2010&nbsp;'.$site_name.'.&nbsp;All Rights Reserved.</p>*/                echo '';
            }
        ?>
