...
/*					//echo "<pre>";print_r($rec);
		...
		{
			echo "<i>Not Saved..</i>"; 
			$_SESSION['error_booking'].="<h2>Booking Not Saved.</h2>";			
		}
...
<script type="text/javascript">
	...
	/****************************************************************************/
	//Displays the selected Individual & Group Teacher available timming table. //
	/****************************************************************************/	
	...
	function getSchedule(tid)
	{
		...
		var url = '<?php echo url('sites/all/modules/hudda_module/teacher_calender.php');?>?date='+on_date+'&tid='+tid;
		$('#ajax_id').load(url);
	...
	************************************************/
	...
	function nextDay(tid,nextORprev)
	{
		...
		var url = '<?php echo url('sites/all/modules/hudda_module/teacher_calender.php');?>?date='+ndate+'&tid='+tid;
		$('#ajax_id').load(url);
...
<form action='' method='post' name='booking_frm'>
	...
	<tr>
		...
		<td width="300px">
			<?php
				if(isset($errMsg) && $errMsg === true)
				{
					echo "<div style='background-color:green; width:300px;'>".$_SESSION['error_booking']."</div>";
				}
				else
				if(isset($errMsg) && $errMsg === false)				
				{
					echo "<div style='background-color:red; width:300px;'>".$_SESSION['error_booking']."</div>";
				}
	...
	<div style="background-color:#03F;">
	...
	<br/>
	<div style="background-color:#03F;">
		<h3>OR, Buy a Individual Lesson Package with Discount</h3>
		<table width="100%">
			<tr>
				<td>
					Number of lessons : 
