...
<!--End Slide-->
    ...
    <ul>
		...
		<li class="act"><a href="<?php echo url('sforms/view_reports_dint_pay');?>">I didn't pay a bribe</a></li>
    ...
    <div class="clear"></div>
    <div class="divtab report_form_head repot2">
...
{
	$num_comment = get_num_comment('notpaid',$row->id);
	?>
...
Reported : <?php echo getDateFormat($row->created,'F j, Y - H:i');?> | City : <?php echo $row->c_city;?> | <?php echo ($row->c_dept!=0)?$row->dept_name:getOthers($row->others_dept);?>
	...
	<div id="less_d_<?php echo $row->id;?>">
        ...
        <a href="<?php echo url('sforms/add_comment');?>?type=notpaid&tid=<?php echo $row->id;?>">Add Comment</a> 
        <a href="<?php echo url('sforms/view_comments_didnt_pay');?>?id=<?php echo $row->id;?>"><?php echo $num_comment;?> Comments</a>        
	...
	<div class="report_reg_more">
        ...
        <a href="<?php echo url('sforms/add_comment');?>?type=notpaid&tid=<?php echo $row->id;?>">Add Comment</a> 
        <a href="<?php echo url('sforms/view_comments_dint_pay');?>?id=<?php echo $row->id;?>"><?php echo $num_comment;?> Comments</a>    
        ...
        <?php
          ...
          $share_url = urlencode($GLOBALS['base_url'].'/sforms/view_report_dint_pay?id='.$row->id);
        ?>
