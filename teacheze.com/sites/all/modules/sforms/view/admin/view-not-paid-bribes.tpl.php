...
?>
	<tr class="<?php echo ($cnt_r%2==0)?'odd':'even';?> <?php echo ($row->approved==1)?'published_row':'unpublished_row'; ?>">
    	<td><a href="<?php echo url('admin/sforms/view_detail_not_paid_bribes');?>?id=<?php echo $row->id;?>"><?php echo $row->c_name;?></a></td>
        ...
        <td>
        	<a href="<?php echo url('admin/sforms/publish_unpublish');?>?type=notpaid&id=<?php echo $row->id;?>&published=<?php echo ($row->approved==0)?'1':'0'; ?>"><strong><?php echo ($row->approved==0)?'No':'Yes'; ?></strong></a>
        </td> 
        <td>
        	<a href="<?php echo url('admin/sforms/delete_bribe');?>?type=notpaid&id=<?php echo $row->id;?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
        </td>       
    </tr>
<?php
$cnt_r++;
