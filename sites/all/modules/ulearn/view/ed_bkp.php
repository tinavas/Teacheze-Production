...
$i_sat		= $row[1]['Sat'];
$i_sun		= $row[1]['Sun'];
$ivals_mon = explode(',',$i_mon);
$ivals_tue = explode(',',$i_tue);
$ivals_wed = explode(',',$i_wed);
$ivals_thu = explode(',',$i_thu);
$ivals_fri = explode(',',$i_fri);
$ivals_sat = explode(',',$i_sat);
$ivals_sun = explode(',',$i_sun);
...
$g_sat		= $row[0]['Sat'];
$g_sun		= $row[0]['Sun'];
$gvals_mon = explode(',',$g_mon);
$gvals_tue = explode(',',$g_tue);
$gvals_wed = explode(',',$g_wed);
$gvals_thu = explode(',',$g_thu);
$gvals_fri = explode(',',$g_fri);
$gvals_sat = explode(',',$g_sat);
$gvals_sun = explode(',',$g_sun);
?>
  ...
  <table border="1">
    <tbody>
      ...
      <tr>
        ...
        <td>
        <?php
		if(count($ivals_mon)>=2){
			for($i=0;$i<count($ivals_mon);$i++){
			?>
			<?php echo $ivals_mon[$i];?>
			<img title=" <?php echo $ivals_mon[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($ivals_tue)>=2){
			for($i=0;$i<count($ivals_tue);$i++){
			?>
			<?php echo $ivals_tue[$i];?>
			<img title=" <?php echo $ivals_tue[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
         <?php
		if(count($ivals_wed)>=2){
			for($i=0;$i<count($ivals_wed);$i++){
			?>
			<?php echo $ivals_wed[$i];?>
			<img title=" <?php echo $ivals_wed[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($ivals_thu)>=2){
			for($i=0;$i<count($ivals_thu);$i++){
			?>
			<?php echo $ivals_thu[$i];?>
			<img title=" <?php echo $ivals_thu[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($ivals_fri)>=2){
			for($i=0;$i<count($ivals_fri);$i++){
			?>
			<?php echo $ivals_fri[$i];?>
			<img title=" <?php echo $ivals_fri[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($ivals_sat)>=2){
			for($i=0;$i<count($ivals_sat);$i++){
			?>
			<?php echo $ivals_sat[$i];?>
			<img title=" <?php echo $ivals_sat[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($ivals_sun)>=2){
			for($i=0;$i<count($ivals_sun);$i++){
			?>
			<?php echo $ivals_sun[$i];?>
			<img title=" <?php echo $ivals_sun[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?></td>
      ...
      <tr>
        ...
        <td>
        <?php
		if(count($gvals_mon)>=2){
			for($i=0;$i<count($gvals_mon);$i++){
			?>
			<?php echo $gvals_mon[$i];?>
			<img title=" <?php echo $gvals_mon[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($gvals_tue)>=2){
			for($i=0;$i<count($gvals_tue);$i++){
			?>
			<?php echo $gvals_tue[$i];?>
			<img title=" <?php echo $gvals_tue[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
         <?php
		if(count($gvals_wed)>=2){
			for($i=0;$i<count($gvals_wed);$i++){
			?>
			<?php echo $gvals_wed[$i];?>
			<img title=" <?php echo $gvals_wed[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($gvals_thu)>=2){
			for($i=0;$i<count($gvals_thu);$i++){
			?>
			<?php echo $gvals_thu[$i];?>
			<img title=" <?php echo $gvals_thu[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($gvals_fri)>=2){
			for($i=0;$i<count($gvals_fri);$i++){
			?>
			<?php echo $gvals_fri[$i];?>
			<img title=" <?php echo $gvals_fri[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($gvals_sat)>=2){
			for($i=0;$i<count($gvals_sat);$i++){
			?>
			<?php echo $gvals_sat[$i];?>
			<img title=" <?php echo $gvals_sat[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?>
        ...
        <td>
        <?php
		if(count($gvals_sun)>=2){
			for($i=0;$i<count($gvals_sun);$i++){
			?>
			<?php echo $gvals_sun[$i];?>
			<img title=" <?php echo $gvals_sun[$i];?>" onclick="delete_sch('I',1,<?php echo $i;?>);" style="cursor: pointer;" src="misc/delete.jpg"><br/>
			<?php
			}
		}
		?></td>
...
?>
  ...
  Price for 45 mins&nbsp;&nbsp;&nbsp;€
  <input type='text' name='group_lession_45min' />
  <br/>
  <br/>
  <br/>
  <b>Packages</b><br/>
  <table border=1>
    ...
    <tr>
      <td rowspan="2"> 10 Lessions </td>
      <td> 30 Minutes </td>
      <td><input type='text' name='10_less_30min_discount' maxlength="2"  onkeyup="disc(10,30, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='10_less_30min_disc_div'></span>
        <input type='hidden' name='10_less_30min_disc_txt' id='10_less_30min_disc_txt'  /></td>
    </tr>
    <tr>
      <td> 45 Minutes </td>
      <td><input type='text' name='10_less_45min_discount' maxlength="2"  onkeyup="disc(10,45, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='10_less_45min_disc_div'></span>
        <input type='hidden' name='10_less_45min_disc_txt' id='10_less_45min_disc_txt' /></td>
    </tr>
    <tr>
      <td rowspan="2"> 30 Lessions </td>
      <td> 30 Minutes </td>
      <td><input type='text' name='30_less_30min_discount' maxlength="2"  onkeyup="disc(30,30, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='30_less_30min_disc_div'></span>
        <input type='hidden' name='30_less_30min_disc_txt' id='30_less_30min_disc_txt'/></td>
    </tr>
    <tr>
      <td> 45 Minutes </td>
      <td><input type='text' name='30_less_45min_discount' maxlength="2"  onkeyup="disc(30,45, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='30_less_45min_disc_div'></span>
        <input type='hidden' name='30_less_45min_disc_txt' id='30_less_45min_disc_txt'/></td>
    </tr>
    <tr>
      <td rowspan="2"> 50 Lessions </td>
      <td> 30 Minutes </td>
      <td><input type='text' name='50_less_30min_discount' maxlength="2"  onkeyup="disc(50,30, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='50_less_30min_disc_div'></span>
        <input type='hidden' name='50_less_30min_disc_txt' id='50_less_30min_disc_txt'/></td>
    </tr>
    <tr>
      <td> 45 Minutes </td>
      <td><input type='text' name='50_less_45min_discount' maxlength="2"  onkeyup="disc(50,45, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='50_less_45min_disc_div'></span>
        <input type='hidden' name='50_less_45min_disc_txt' id='50_less_45min_disc_txt'/></td>
    </tr>
    <tr>
      <td rowspan="2"> 100 Lessions </td>
      <td> 30 Minutes </td>
      <td><input type='text' name='100_less_30min_discount' maxlength="2"  onkeyup="disc(100,30, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='100_less_30min_disc_div'></span>
        <input type='hidden' name='100_less_30min_disc_txt' id='100_less_30min_disc_txt'/></td>
    </tr>
    <tr>
      <td> 45 Minutes </td>
      <td><input type='text' name='100_less_45min_discount' maxlength="2"  onkeyup="disc(100,45, this.value);"/>
        (from 1 to 10) </td>
      <td>&nbsp;&nbsp;&nbsp;€ <span id='100_less_45min_disc_div'></span>
