...
function validate_m()
{
    ...
    <a href="<?php echo url('sforms/view_reports_didnt_pay');?>"><img src="<?php echo url('sites/all/themes/ipab_client/');?>images/view-reports.png" title="view reports" /></a>
	</div><!--End Slide-->
...
<li class="act"><a href="<?php echo url('sforms/register/i_didnt_pay_a_bribe');?>">I didn't pay a bribe</a></li>
...
<form action="" onsubmit="return validate_m();" method="post">
           ...
           <div>
           	...
           	<label id="resisted_by_l" for="resisted_by">Resisted a bribe</label>
           ...
           <!-- <p>
			<input type="radio" name="resisted_type" onclick="changeColor('govt_official','resisted_by');" id="govt_official" value="govt" /> <label id="govt_official_l" for="govt_official">Came accross</label> &nbsp;<strong>An honest goverment official.</strong>
            </p> -->    
            <script type="text/javascript">
