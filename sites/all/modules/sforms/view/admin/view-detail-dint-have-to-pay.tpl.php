...
<table width="100%">
    ...
    <tr>
    	<td colspan="2">
        <br />
        	<input type="button" value="back" onclick="document.location.href='<?php echo url('admin/sforms/view_dint_have_to_pay');?>';" />
            <input type="button" value="<?php echo ($row->approved==0)?'Publish It':'Unpublish It'; ?>" onclick="document.location.href='<?php echo url('admin/sforms/publish_unpublish');?>?type=dinthvtopay&id=<?php echo $row->id;?>&published=<?php echo ($row->approved==0)?'1':'0'; ?>';" />
        </td>
    </tr>
