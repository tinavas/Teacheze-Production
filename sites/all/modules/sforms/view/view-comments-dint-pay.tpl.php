...
<p><a href="<?php echo url('sforms/view_reports_didnt_pay');?>" class="yellow_box">&lt;&lt; Back To Reports</a></p>
<br />
...
<div class="report_reg">
<a href="<?php echo url('sforms/add_comment');?>?type=notpaid&tid=<?php echo $row_det->id;?>" class="yellow_box">Add a comment</a>
<br /><br />
