...
function languageschoolireland_2_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function languageschoolireland_2_feed_icon($url, $title) {
 ...
 */
function languageschoolireland_2_preprocess_comment_wrapper(&$vars) {
