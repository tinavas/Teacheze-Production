 ...
 */
function languageschoolireland_2_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function languageschoolireland_2_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function languageschoolireland_2_button($element) {
...
*/
function languageschoolireland_2_img_assist_page($content, $attributes = NULL) {
