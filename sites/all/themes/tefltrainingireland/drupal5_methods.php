...
function languageschoolireland_2_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function languageschoolireland_2_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function languageschoolireland_2_feed_icon($url) {
 ...
 */
function languageschoolireland_2_comment_wrapper($content, $type = null) {
  static $node_type;
