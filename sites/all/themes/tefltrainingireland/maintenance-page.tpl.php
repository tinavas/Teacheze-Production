...
<?php $r = art_sidebar($right, $sidebar_right);
echo '<div class="'.art_get_sidebar_style($r, $vnavigation_right, 'art-content').'">'; ?>
...
<?php $r = art_sidebar($right, $sidebar_right);
if (!empty($r) || !empty($vnavigation_right)) echo '<div class="'.art_get_sidebar_style($r, $vnavigation_right, 'art-sidebar1').'">' . $vnavigation_right . $r . "</div>"; ?>
    ...
    <div class="art-footer-inner">
        <?php 
            if (!empty($feed_icons)) {
                ...
                echo '<a href="rss.xml" class="art-rss-tag-icon"></a>';
            }
        ?>
